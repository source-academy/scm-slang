import { cons, set$45$cdr$33$ } from "../../stdlib/base";
import { decode, decodeValue, encode } from "../encode-utils";
...
describe("Scheme encoder and decoder", () => {
  ...
  it("decoder works on pairs", () => {
    ...
    function $65$() {}
    const pair = cons($65$, "placeholder");
    expect(decodeValue(pair).toString()).toEqual(
      `function A() { },placeholder`,
    );
  });
