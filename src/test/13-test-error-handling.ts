...
function testErrorHandling() {
  ...
  const testCases = [
    // Syntax errors
    {
      code: "(define x)",
      expected: "Error",
      description: "Define with missing value",
    },
    {
      code: "(define 10 x)",
      expected: "Error",
      description: "Define with non-identifier name",
    },
    {
      code: "(if (> 5 3))",
      expected: "Error",
      description: "If with missing else clause",
    },
    {
      code: "(lambda x y)",
      expected: "Error",
      description: "Lambda with invalid parameters",
    },
    ...
    { code: "(cdr 42)", expected: "Error", description: "Cdr on non-pair" },
    {
      code: "(cons 1 2 3)",
      expected: "Error",
      description: "Cons with too many arguments",
    },
    ...
    {
      code: "(not-a-function 1 2 3)",
      expected: "Error",
      description: "Call undefined function",
    },
    {
      code: "(+ 1 2 3 4 5)",
      expected: { type: "number", value: 15 },
      description: "Add with many arguments (should work)",
    },
    ...
    // Type predicate errors
    {
      code: "(number? 1 2)",
      expected: "Error",
      description: "Number? with too many arguments",
    },
    {
      code: "(string? 1 2)",
      expected: "Error",
      description: "String? with too many arguments",
    },
    {
      code: "(boolean? 1 2)",
      expected: "Error",
      description: "Boolean? with too many arguments",
    },
    ...
    // Boolean operation errors
    {
      ...
      description: "And with no arguments (should return true)",
    },
    {
      code: "(or)",
    ...
    },
    {
      code: "(not 1 2)",
      expected: "Error",
      description: "Not with too many arguments",
    },
    ...
    // Complex number errors
    {
      code: '(+ 3+4i "hello")',
      expected: "Error",
      description: "Complex addition with string",
    },
    {
      code: "(+ 3+4i #t)",
      expected: "Error",
      description: "Complex addition with boolean",
    },
    ...
    // List operation errors
    {
      ...
      description: "List with many arguments (should work)",
    },
    {
      code: "(null? 1 2)",
      expected: "Error",
      description: "Null? with too many arguments",
    },
    {
      code: "(pair? 1 2)",
      expected: "Error",
      description: "Pair? with too many arguments",
    },
  ];
  ...
  for (const testCase of testCases) {
    try {
      ...
      if (testCase.expected === "Error") {
        console.log(
          `❌ ${testCase.description}: ${testCase.code} -> Should have thrown error but got ${JSON.stringify(result)}`
        );
        failed++;
      } else {
        const success =
      ...
      if (testCase.expected === "Error") {
        ...
        console.log(
          `❌ ${testCase.description}: ${testCase.code} -> Unexpected ERROR: ${error.message}`
        );
        failed++;
      }
    }
